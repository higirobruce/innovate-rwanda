    ...
    <component :is="layout">
      ...
      <p>
        <span style="font-weight: 400"
          ...
          laws of the Rwandan Government, foreign jurisdictions, and
      ...
      <p>
        <span style="font-weight: 400"
          ...
          access solely for your personal, non&shy;commercial use. We reserve
      ...
      <p>
        <span style="font-weight: 400"
          ...
          non&shy;human means, whether through a bot, script or otherwise; (6)
      ...
      <ol>
        ...
        <li>
          <span style="font-weight: 400">
            ...
            use the Site and/or the Content for any revenue &shy;generating
      ...
      <p>
        <span style="font-weight: 400"
          ...
          blogs, events, jobs, and other functionality, and may provide you with
          ...
          non&shy;confidential and non&shy;proprietary. When you create or make
      ...
      <ol>
        ...
        <li>
          <span style="font-weight: 400"
            ...
            physical harm against another.</span
          >
        </li>
        <li>
          <span style="font-weight: 400"
        ...
        <li>
          <span style="font-weight: 400"
            ...
            of any third party. 11. Your Contributions do not contain any
            ...
            violent manner. 12. Your Contributions do not violate any federal or
            state law concerning child pornography, or otherwise intended to
            protect the health or well&shy;being of minors;
          </span>
        </li>
        <li>
          <span style="font-weight: 400"
      ...
      <p>
        <span style="font-weight: 400"
          ...
          re&shy;categorize any Contributions to place them in more appropriate
          locations on the Site; and (3) to pre&shy;screen or delete any
      ...
      <p>
        <span style="font-weight: 400"
          ...
          Policy: innovaterwanda.rw/privacy policy. By using the Site, you agree
          to be bound by our Privacy Policy, which is incorporated into these
          Terms of Use. Please be advised the Site is hosted in Rwanda. If you
          ...
          Rwanda, then through your continued use of the Site, you are
          transferring your data to Rwanda, and you expressly consent to have
          your data transferred to and processed in Rwanda. Further, we do not
          ...
          Rwandan Children&rsquo;s Online Privacy Protection Act, if we receive
      ...
      <p>
        <span style="font-weight: 400"
          ...
          construed in accordance with the laws of the Rwandan Government
          applicable to agreements made and to be entirely performed within the
          Rwanda, without regard to its conflict of law principles.
        </span>
      </p>
      ...
      <p>
        <span style="font-weight: 400"
          ...
          &ldquo;Party&rdquo;) shall be commenced or prosecuted in the state and
          federal courts located in Rwanda, and the Parties hereby consent to,
          ...
          federal courts. In no event shall any claim, action, or proceeding
      ...
      <p>
        <span style="font-weight: 400"
          >THE SITE IS PROVIDED ON AN AS&shy;IS AND ASAVAILABLE BASIS. YOU AGREE
          ...
          BETWEEN YOU AND ANY THIRD&shy;PARTY PROVIDERS OF PRODUCTS OR SERVICES.
      ...
      <p>
        <span style="font-weight: 400"
          ...
          non&shy;electronic records, or to payments or the granting of credits
