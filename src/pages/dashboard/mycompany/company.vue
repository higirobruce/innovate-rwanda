  ...
  <div>
    ...
    <!-- <component :is="layout">
      <div class="page-info px-5">
        ...
        <div class="alert alert-danger mt-2" v-if="profile.role !== 'normal'">
          You are viewing this page because you are admin.
          <router-link :to="'/'"> See all companies </router-link>
        </div>
      </div>
      <div
          ...
          <div class="company-info">
            <div>
              <span>
                ...
                >
                  <span v-if="_.size(JSON.parse(company.company.customerBase))"
                  ...
                  >
                    ...
                    >
                      <input
                        ...
                        @input="changeBase"
                      />
                      <label class="form-check-label" :for="`base-id-${index}`">
                        {{ base }}
                      </label>
                    </div>
                  </div>
...
export default {
  ...
  methods: {
    ...
    changeBase(e) {
      ...
      if (
        !JSON.parse(this.company.company.customerBase.includes(e.target.value))
      ) {
