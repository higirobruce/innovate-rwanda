      ...
      <div class="dash-container">
        <div v-if="profile.role === 'normal'">
          ...
          <div class="alert alert-success" v-if="created && !uploading">
            Your event has been created successfully! Our admins will review and published it.
          </div>
          <!-- FORM: CREATE BLOG -->
          <div class="row">
            ...
            <div class="col-sm-12 col-md-4 col-l-4">
              <div class="content-form-sidebar">
                ...
                <h3 class="h6 mt-3">Event poster/flyer</h3>
...
export default {
  ...
  mounted() {
    ...
    this.event.author = `${this.profile.id}`;
    this.event.companyId = `${this.profile.companyId}`;
  },
  methods: {
    changeCategory(e) {
    ...
    savePost(status) {
      ...
      if (this.tags) {
        ...
        this.event.tags = JSON.stringify(getTags);
      }
    ...
    submitPostNow() {
      ...
      this.event.eventDate = '2020-12-04 11:07:46+02';
      this.event.eventTime = '2020-12-04 11:07:46+02';
      AxiosHelper.post("events", this.event)
        .then(() => {
          this.created = true;
          Vue.$toast.open({
            message: "Event been created successfully",
            type: "success",
          });
          setTimeout(() => {
            // this.$router.go();
      ...
      this.$refs.cropper.getCroppedCanvas().toBlob((blob) => {
        ...
        axios
          ...
          .then((response) => {
            ...
            this.event.image = `v${response.data.version}/${response.data.public_id}.${response.data.format}`;
            this.submitPostNow();
          })
          .catch(() => {
            this.uploading = false;
